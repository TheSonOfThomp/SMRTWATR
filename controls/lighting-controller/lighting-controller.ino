...
void loop() {
    switch (ledMode) {
       ...
       case '1': BRIGHTNESS = 255; Rainbow(); break;              //Rainbow -- Change STEPS and SPEED to modify
       case '2': sinwave_1(); break;            //Sin Wave -- Change sinwave variables to modify
       case '3': ripple(); break;               //Ripple -- Change 
       case '4': BRIGHTNESS=0; Solid(); break;  //all off -- change BRIGHTNESS to 1-255 for a solid color
    }  
